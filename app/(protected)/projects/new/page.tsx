...
const NewProjectPage = () => {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(true);
      router.push("/projects/" + slugify(title));
    } catch (err) {
      console.error(err);
      const message =
          ...
          <div className="flex items-center justify-between gap-4">
            <div>
              <div className="flex items-center gap-3">
                ...
                <CardTitle className="m-0">Create New Project</CardTitle>
              </div>
              <CardDescription className="mt-1">
                Start a new project by filling in the details below. Click save
                when done.
              </CardDescription>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="w-full min-h-[70px] resize-none rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
                    placeholder="A short, 1-2 sentence summary of the project"
                  />
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    placeholder="A detailed description of the project, including objectives, requirements, and any other relevant information. 
